...
def test_build_artifact_evidence_index_classifies_copied_proof_artifacts(tmp_path: Path):
    ...
    run_dir = proof_root / "lob_10m_multi_symbol"
    ...
    (proof_root / "lob_10m_multi_symbol.tar.gz").write_bytes(b"small proof bundle")
    ...
    assert "`lob_10m_multi_symbol/lob_manifest_SPY_2019-12-30_5404209.json`" in content
