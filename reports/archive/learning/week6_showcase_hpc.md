...
- `message_events` Parquet: `/scratch/users/hashar/itch-data-pipeline/outputs/hpc/dataset=message_events/date=2019-12-30/symbol=ALL/part-000.parquet`
- `message_events` manifest: `/scratch/users/hashar/itch-data-pipeline/outputs/hpc/dataset=message_events/date=2019-12-30/symbol=ALL/manifest.json`
- `message_events` validation: `/scratch/users/hashar/itch-data-pipeline/outputs/hpc/dataset=message_events/date=2019-12-30/symbol=ALL/validation_report.json`
- `order_events` Parquet: `/scratch/users/hashar/itch-data-pipeline/outputs/hpc/dataset=order_events/date=2019-12-30/symbol=ALL/part-000.parquet`
- `order_events` manifest: `/scratch/users/hashar/itch-data-pipeline/outputs/hpc/dataset=order_events/date=2019-12-30/symbol=ALL/manifest.json`
- `order_events` validation: `/scratch/users/hashar/itch-data-pipeline/outputs/hpc/dataset=order_events/date=2019-12-30/symbol=ALL/validation_report.json`
